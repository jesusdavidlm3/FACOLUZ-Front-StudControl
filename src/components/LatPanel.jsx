    ...
    return(
        <div className='LatPanel'>
            ...
            <div className='buttons'>
                ...
                <Button className='Button' size={'large'} onClick={()=>{setView('CheckAsign')}} variant='solid' icon={<ClockCircleOutlined />}><p className='invisible'>Cerrar inscripciones</p></Button> 
